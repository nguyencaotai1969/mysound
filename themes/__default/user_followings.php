...
<div>
	...
	<div id="user_content" >
	  <div class="users acts">
	    <?php if ( empty( $page_data["followings"]["acts"] ) ) : ?>
	    ...
	    <?php ;else: ?>
		  ...
		  <?php foreach( $page_data["followings"]["acts"] as $_f ) : $_f["user"] = $_f["data"]["user"]; ?>
          <div class="user">
	      ...
	      <?php if ( !empty( $page_data["followings"]["has_more"] ) ) : ?>
		  <div class="load_more_wrapper">
		    <a class="load_more_link" href="<?php echo $page_data["followings"]["has_more"]; ?>"><?php $loader->lorem->eturn( "load_more", [ "uc" => true ] ); ?></a>
		  </div>
		  <?php endif; ?>
