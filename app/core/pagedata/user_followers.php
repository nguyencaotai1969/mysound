...
$this->page_data = [
	...
	"followers"       => $loader->user->set( $req_user_id )->get_acts( [
	    "user_id"  => null,
			"user_id_2" => $req_user_id,
	    "acts_ids" => [ 6 ],
	    "page"     => $page
    ] )
];

if ( empty( $this->page_data["followers"] ) && $page > 1 ) $loader->html->set_http_header( "status", "HTTP/1.0 404 Not Found" );
