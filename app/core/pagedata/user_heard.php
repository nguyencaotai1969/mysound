...
$this->page_data = [
	...
	"user_heard"      => $loader->user->set( $req_user_id )->get_heard( [
	    "user_id"  => $req_user_id,
	    "page"     => $page
    ] )
];

if ( empty( $this->page_data["user_heard"]["tracks"] ) && $page > 1 ) $loader->html->set_http_header( "status", "HTTP/1.0 404 Not Found" );
