...
$this->page_data = [
	...
	"user_reposts"    => $loader->user->set( $req_user_id )->get_acts( [
	    "user_id"  => $req_user_id,
	    "acts_ids" => [ 2 ],
	    "page"     => $page
    ] )
...
if ( empty( $this->page_data["user_reposts"] ) && $page > 1 ) $loader->html->set_http_header( "status", "HTTP/1.0 404 Not Found" );

$loader->ui->set_title( [ "users" => $req_user_data["name_raw"] ] );
